				...
				<div class="col-md-12 column">
					...
					<div class="page-header text-center">
						<a href="${host}" style="text-decoration : none"><h1>
							Zookeeper-Cli <#--<small>简单一点 方便一点</small>-->
						</h1></a>
					</div>
      ...
      <div class="modal-body">
          <form class="form col-md-12 center-block" action="${host}/login" method="POST">
            ...
            <div class="form-group">
              ...
              <span class="pull-left">帐号的配置在/zookeeper-cli/src/main/resources/conf/user.properties</span><#--<span><a href="#">Need help?</a></span>-->
            </div>
          </form>
      </div>
